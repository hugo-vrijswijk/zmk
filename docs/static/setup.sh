...
options=("Kyria" "Lily58" "Corne" "Splitreus62" "Sofle" "Iris" "Reviung41" "RoMac" "RoMac+" "makerdiary M60" "Microdox" "TG4X" "QAZ" "NIBBLE" "Jorne" "Jian" "CRBN" "Tidbit" "Eek!" "BFO-9000" "Helix" "Redox")
...
select opt in "${options[@]}" "Quit"; do
    ...
    22 ) shield_title="Redox" shield="redox"; split="y"; break;;
